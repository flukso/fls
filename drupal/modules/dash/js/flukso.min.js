...
Flukso.chartDefaults={chart:{renderTo:"chart",backgroundColor:"#f5f5f5",animation:{duration:400,easing:"swing"},events:{}},colors:"#E41A1C #377EB8 #4DAF4A #FF7F00 #984EA3 #999999 #A65628 #F781BF".split(" "),credits:{enabled:!1},plotOptions:{line:{animation:{duration:400,easing:"swing"},connectNulls:!1,lineWidth:2}},rangeSelector:{enabled:!1},xAxis:{gridLineWidth:1,gridLineDashStyle:"ShortDot",lineColor:"#000",tickColor:"#000",labels:{style:{color:"#000",font:'13px "Helvetica Neue", Helvetica, Arial, sans-serif'}},
title:{style:{color:"#333",fontWeight:"bold",fontSize:"14px",fontFamily:'"Helvetica Neue", Helvetica, Arial, sans-serif'}}},yAxis:{min:0,minorTickInterval:"auto",gridLineWidth:1,gridLineDashStyle:"ShortDot",minorGridLineDashStyle:"ShortDot",lineColor:"#000",lineWidth:1,tickWidth:1,tickColor:"#000",labels:{style:{color:"#000",font:'13px "Helvetica Neue", Helvetica, Arial, sans-serif'}},title:{style:{color:"#333",fontWeight:"bold",fontSize:"14px",fontFamily:'"Helvetica Neue", Helvetica, Arial, sans-serif'}}},
series:[]};Flukso.ChartState=Backbone.NestedModel.extend({defaults:{init:!0,reloadChart:!0,refreshData:!1,type:"electricity",interval:"day",unit:{electricity:"watt",gas:"lperday",water:"lperday"},unitRt:{electricity:"watt",gas:"lperday",water:"lperday"},cumul:!1,count:{electricity:0,gas:0,water:0}}});
...
Flukso.TypeView=Backbone.View.extend({el:"#type",initialize:function(){_.bindAll(this,"render");this.model.bind("change:type",this.render);this.render()},render:function(){$("#type li a").removeClass("active");var a="#"+this.model.get("type");$(a).button("toggle");return this},events:{click:"clickButton"},clickButton:function(a){Flukso.alertView.clear();this.model.set({type:$(a.target).attr("id")});this.model.set({cumul:!1});this.model.set({reloadChart:!0})}});
Flukso.IntervalView=Backbone.View.extend({el:"#interval",initialize:function(){_.bindAll(this,"render");this.model.bind("change:interval",this.render);this.render()},render:function(){$("#interval li a").removeClass("active");var a="#"+this.model.get("interval");$(a).button("toggle");return this},events:{click:"clickButton"},clickButton:function(a){Flukso.alertView.clear();this.model.set({interval:$(a.target).attr("id")});this.model.set({reloadChart:!0})}});
Flukso.UnitView=Backbone.View.extend({el:"#unit",initialize:function(){_.bindAll(this,"render");this.model.bind("change:type",this.render);this.model.bind("change:interval",this.render);this.render()},render:function(){$("#unit.dropdown-menu a").hide();var a="#unit.dropdown-menu a."+this.model.get("type");"minute"==this.model.get("interval")&&(a+=".rt");$(a).show();return this},events:{click:"clickDropdown"},clickDropdown:function(a){Flukso.alertView.clear();var b={electricity:this.model.get("unit.electricity"),
gas:this.model.get("unit.gas"),water:this.model.get("unit.water")},a=a.target;b[this.model.get("type")]=$(a).attr("id");this.model.set({unit:{electricity:b.electricity,gas:b.gas,water:b.water}});this.model.set({cumul:$(a).hasClass("cumul")});this.model.set({reloadChart:!0})}});
